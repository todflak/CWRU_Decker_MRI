...
% This code is modified from the spm_realign.m from the SPM package. The
...
% perfusion MRI.
% Ref: 1. Ze Wang, Improving cerebral blood flow quantification for
% arterial spin labeled perfusion MRI by removing residual motion artifacts
% and global signal fluctuations,
%         Magnetic Resonance Imaging, 2012 (in press).
%         http://dx.doi.org/10.1016/j.mri.2012.05.004
% 2. Ze Wang, Geoffrey Aguirre, Hengyi Rao, JiongJ Wang, Anna R. Childress,
% John A. Detre, Empirical optimization of ASL data analysis using an ASL
% data processing toolbox: ASLtbx, Magnetic Resonance Imaging, 2008,
% 26(2):261-9
...
if ~isempty(fg),
	...
	legend(ax, s, 'Location', 'Best')   %changed by TF 4 May 2017:  was: legend(ax, s, 0)
