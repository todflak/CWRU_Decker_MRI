...
% I have now removed the constraints on how many voxels could be added.  In
% the original code, each padding amount was constrained to be less than
% the original distance of the origin from that side.  But I cannot
% rationalize why there should be this restriction... there is no reason
% why we cannot add an unlimited number of voxels on any side.
% Tod Flak 31 Aug 2017
