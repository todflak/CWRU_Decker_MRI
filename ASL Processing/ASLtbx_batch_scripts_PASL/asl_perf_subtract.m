...
fprintf(fidLog, 'asl_perf_subtract parameter summary: \n');
...
if DumpCBF_DataFlag, cbfdata_all = zeros(size(vxidx,1),perfno); end
...
for p=1:perfno
   ...
   if CBFFlag==1
      ...
      Outlier_LowThreshold = -40;
      Outlier_HighThreshold = 150;
      ...
      Outlier_LowThreshold = -15;
      Outlier_HighThreshold = 30;
   ...
   tabResults(p,:) = table(Perfusion_Mean_All,Perfusion_Mean_Cleaned,CBF_Mean_All,CBF_Mean_Cleaned, CountVoxels_All, CountVoxels_Cleaned, Outliers_Low_Count, Outliers_High_Count);
...
if DumpCBF_DataFlag
   CBF_DataFilename = fullfile(pth, ['CBF_Data_' num2str(SubtractionType) '.xlsx']);
   xlswrite(CBF_DataFilename,cbfdata_all);
end;
